...
var SubmitModal = /** @class */ (function (_super) {
    ...
    SubmitModal.prototype.getDefaultConfig = function () {
        return __assign({ parentForm: null, uri: '', fieldId: '' }, _super.prototype.getDefaultConfig.call(this));
    };
    ...
    SubmitModal.prototype.click = function (event) {
        ...
        form
            ...
            var id = data.id;
            var mainField = parentForm.getFieldById(fieldId);
            if (!mainField)
                throw new Error('Original field not found!');
            mainField.addValue(id, (_b = (_a = data['name']) !== null && _a !== void 0 ? _a : data['title']) !== null && _b !== void 0 ? _b : 'No title found! :(');
...
var ButtonAbstract = /** @class */ (function (_super) {
    ...
    ButtonAbstract.prototype.formValidate = function () {
        var form = this.form;
        if (!form.validate()) {
...
var Api = /** @class */ (function (_super) {
    ...
    Api.prototype.ajax = function (method) {
        var settings = typeof method == 'string'
            ? this.ajaxSettings(method)
            : method;
        return new Promise(function (resolve, reject) {
            jQuery.ajax(settings).done(function (data) { resolve(data); }).fail(function (error) { reject(error); });
        });
    };
...
var DataAbstract = /** @class */ (function (_super) {
    ...
    DataAbstract.prototype.process = function (data) {
        var processItem = this._processItem;
    ...
    DataAbstract.prototype.error = function (error) {
        ...
        this.notify(new DataEvent_1.DataEvent(this, DataAbstract.DATA_ERROR, null, null));
        !this._errorItem || this._errorItem(error);
        throw new Error(error);
    };
    DataAbstract.prototype.finished = function () {
        this.notify(new DataEvent_1.DataEvent(this, DataAbstract.DATA_FINALLY, null, this._data));
    ...
    DataAbstract.prototype.set = function (id, value) {
        if (value === undefined)
            return;
        this.notify(new DataEvent_1.DataEvent(this, DataAbstract.DATA_PRE_SET, id, value));
        this._data[id] = value;
        this.notify(new DataEvent_1.DataEvent(this, DataAbstract.DATA_POST_SET, id, value));
    };
    ...
    Object.defineProperty(DataAbstract.prototype, "processItem", {
        get: function () {
    ...
    Object.defineProperty(DataAbstract.prototype, "errorItem", {
        get: function () {
    ...
    Object.defineProperty(DataAbstract.prototype, "finishedItem", {
        get: function () {
...
var DataEvent = /** @class */ (function (_super) {
    ...
    function DataEvent(source, event, id, data) {
        if (data === void 0) { data = {}; }
...
var ObserverAbstract_1 = __webpack_require__(/*! mudde-core/src/Core/ObserverPattern/ObserverAbstract */ "./node_modules/mudde-core/src/Core/ObserverPattern/ObserverAbstract.ts");
var SubjectAbstract_1 = __webpack_require__(/*! mudde-core/src/Core/ObserverPattern/SubjectAbstract */ "./node_modules/mudde-core/src/Core/ObserverPattern/SubjectAbstract.ts");
var Data_1 = __webpack_require__(/*! ./Data */ "./src/Data/index.ts");
var Form = /** @class */ (function (_super) {
    ...
    function Form(config) {
        ...
        _this._additionalJs = [];
        _this._click = ['click'];
        _this._change = ['keydown', 'keypress', 'keyup', 'mousedown', 'mouseup', 'change'];
        _this.form = new NodeCore_1.NodeCore('form');
        !jQuery.isEmptyObject(Form.forms) || _this.setValidationDefaults();
        _this.configuring(config);
        _this.updateForm();
    ...
    Form.prototype.setValidationDefaults = function () {
    ...
    Form.prototype.configureFields = function (rawFields) {
        ...
        rawFields.forEach(function (config) {
            ...
            var object = new className(config, main, data);
    ...
    Form.prototype.configureData = function (config) {
        ...
        if (!type || !className)
            throw new Error("Datatype '".concat(type, "' not found for found for form!"));
    ...
    Form.prototype.getFormData = function () {
        ...
        for (var fieldName in fields) {
            ...
            var properName = fieldName.substring(fieldName.indexOf('_') + 1);
            var data = field.getValue();
            var anEmptyId = properName === 'id' && data[0] != undefined && data[0] == '';
            if (!anEmptyId) {
    ...
    Object.defineProperty(Form.prototype, "parent", {
        get: function () {
    ...
    Form.EVENT_FORM_PRE_POST = 32;
    Form.EVENT_FORM_POST_POST = 64;
    Form.forms = {};
    return Form;
}((0, ts_mixer_1.Mixin)(ConfigurableAbstract_1.ConfigurableAbstract, SubjectAbstract_1.SubjectAbstract, ObserverAbstract_1.ObserverAbstract)));
exports.Form = Form;
...
var GroupInputAbstract = /** @class */ (function (_super) {
    ...
    GroupInputAbstract.prototype.configureInputData = function (config) {
        var main = this;
        var object = null;
        var type = StringHelper_1.StringHelper.ucFirst(config['_type']);
        var className = window['MuddeFormgen'].Data[type];
        if (!type)
            throw new Error('Datatype fot found for form!');
...
var BootstrapHelper = /** @class */ (function () {
    ...
    BootstrapHelper.modal = function (id) {
        var modelId = BootstrapHelper.getModelId(id);
    ...
    BootstrapHelper.getModelId = function (id) {
        return 'model_' + id;
    };
...
var Combobox = /** @class */ (function (_super) {
    ...
    function Combobox(config, form, data) {
        ...
        var id_prefix = inputData instanceof Data_1.Api ? "/".concat(inputData.url, "/") : '';
        var id = _this.id.split('_')[1];
        _this.form.attach(Form_1.Form.EVENT_FORM_PRE_POST, function (event) {
            var data2 = event.source;
            data2[id] = id_prefix + data2[id];
        });
        return _this;
    }
    Combobox.prototype.getDefaultConfig = function () {
        return __assign(__assign({}, _super.prototype.getDefaultConfig.call(this)), { inputData: new Array_1.Array({ data: [] }), multiple: false });
    };
    Combobox.prototype.configureInputData = function (rawData) {
        var main = this;
        var type = StringHelper_1.StringHelper.ucFirst(rawData['_type']);
        var className = window['MuddeFormgen'].Data[type];
        var inputData = this._inputData = rawData instanceof DataAbstract_1.DataAbstract ? rawData : new className(rawData, main);
        inputData.attach(DataAbstract_1.DataAbstract.DATA_POST_SET, function (event) {
            var _a, _b;
            var data = event.data;
            main.addValue(data.id, (_b = (_a = data.name) !== null && _a !== void 0 ? _a : data.title) !== null && _b !== void 0 ? _b : 'No title :(');
        });
    };
    ...
    Combobox.prototype.getValue = function () {
        var data = this.coreHTMLElements.map(function (item) {
    ...
    Object.defineProperty(Combobox.prototype, "inputData", {
        get: function () {
...
var Email = /** @class */ (function (_super) {
    ...
    Email.prototype.getValue = function () {
        return this.coreHTMLElements.map(function (item) {
...
var Select2 = /** @class */ (function (_super) {
    ...
    function Select2(config, form, data) {
        var _this = this;
        config['finishedItem'] = function (event) {
            var id = _this.id;
            var x = $('#' + id).select2();
        };
        _this = _super.call(this, config, form, data) || this;
        return _this;
    }
...
var Select2Relation = /** @class */ (function (_super) {
    ...
    function Select2Relation(config, form, data) {
        var _this = _super.call(this, config, form, data) || this;
        var main = _this;
        _this.inputData.attach(DataAbstract_1.DataAbstract.DATA_FINALLY, function (event) { main.update(event); });
        return _this;
    }
    ...
    Select2Relation.prototype.update = function (event) {
        ...
        var buttonAttributes = { type: "button", class: "btn btn-primary btn-self", "data-bs-toggle": "modal", "data-bs-target": "#" + Helper_1.BootstrapHelper.getModelId(id) };
        var addButton = new NodeCore_1.NodeCore('button', buttonAttributes, '+');
        ...
        jQuery
            ...
            var replaceButton = config.buttons.find(function (button) { return button._type === 'Submit'; });
...
var InputAbstract = /** @class */ (function (_super) {
    ...
    function InputAbstract(form, data) {
        ...
        _this._handleDataEvent = function (event) {
            var id = event.id;
            var dataSource = event.source;
            var data = dataSource.get(id);
            _this.addValue(id, data);
        };
        _this._updateDataEvent = function (event) {
            var input = event.source;
            var dataSource = input._data;
            dataSource.pauseAttach(_this._handleDataEvent);
            console.debug('------------------------------------- pause -------------------------------------');
            dataSource.set(input.id, input.getValue());
            dataSource.pauseDetach(_this._handleDataEvent);
    ...
    InputAbstract.prototype.javascript = function () { };
    ...
    InputAbstract.prototype.appendNode = function (tagName, attributes, text) {
        if (text === void 0) { text = null; }
        this.coreHTMLElements.forEach(function (element) {
            element.appendNode(tagName, attributes, text);
        });
    };
    InputAbstract.prototype.setAttributes = function (value) {
        this.coreHTMLElements.forEach(function (item) {
    ...
    InputAbstract.EVENT_INPUT_FINISHED = 4;
    InputAbstract.EVENT_INPUT_PRE_CHANGE = 8;
    InputAbstract.EVENT_INPUT_POST_CHANGE = 16;
